...
CANONICAL_RESULT_FIELDS = [
    "status", "work_package_id", "task_ids", "task_versions", "change_versions",
    "run_id", "outcomes", "changed_files", "validation",
    "acceptance_evidence", "effect_checks", "risks",
]

CANONICAL_RUNNER_IDENTITY = {
    "parent_session_id": {"source": "caller-or-CODEX_THREAD_ID", "required_in_persisted_task": True},
    "agent_id": {"source": "runner-generated-at-dispatch", "caller_must_omit": True},
    "run_id": {"source": "runner-generated-at-dispatch", "caller_must_omit": True},
    "session_id": {"source": "runner-generated-or-resume-record", "caller_must_omit_on_start": True},
    "client": {"source": "runner-forced", "value": "qoder"},
}
...
class PlanningValidator:
    ...
    def check_all_entity_ids(self):
        ...
        for scope in self.path_scopes:
            ...
            if not sid or not isinstance(sid, str):
                self.errors.append(f"invalid-scope-id: empty or missing scope name")
    ...
    def check_cross_source_handoff(self):
        ...
        canonical_caller = list(CANONICAL_CALLER_FIELDS)
        canonical_result = list(CANONICAL_RESULT_FIELDS)
        ...
        for n in names:
            ...
            if identity != CANONICAL_RUNNER_IDENTITY:
                self.errors.append(
        ...
        for n in names:
            ...
            if schema is not None and (
                not isinstance(schema, dict) or schema != CANONICAL_CALLER_FIELD_SCHEMA
            ):
                self.errors.append(
