...
# Python otherwise places ``scripts/harness`` rather than the repository root
...
def bind_main_task(repo_root: str | Path, task_id: str) -> dict[str, Any]:
    from scripts.harness.codex_work_package import build_codex_main_task_projection, _write_exclusive
...
def main() -> int:
    import argparse
    from scripts.harness.codex_work_package import CodexWorkPackageError
