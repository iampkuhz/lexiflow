...
from scripts.harness.codex_work_package import (
...
class CodexWorkPackagePublisherTest(unittest.TestCase):
    ...
    def _catalog(self) -> None:
        ...
        for index, task_id in enumerate(self.tasks, 1):
            records.append({
                ...
                "allowed_files": ["scripts/harness/codex_work_package.py"],
    ...
    def _caller(self) -> dict:
        return {
            ...
            "allowed_files": "scripts/harness/codex_work_package.py", "forbidden_files": "secrets/**",
    ...
    def test_scope_uses_dispatch_coverage_instead_of_substring_matching(self) -> None:
        caller = self._caller()
        caller["allowed_files"] = "scripts/harness/codex_work_package.py.extra"
        with self.assertRaisesRegex(CodexWorkPackageError, "catalog-drift"):
