...
from scripts.acceptance.validate import ValidationError,validate
from tests.acceptance.fixtures import AcceptanceFixture,PRODUCER_SESSION,VALIDATOR_SESSION,make_mock_runtime
class TestValidate(unittest.TestCase):
 def setUp(self):self.f=AcceptanceFixture();self.f.create_verification_report();self.f.create_submission()
